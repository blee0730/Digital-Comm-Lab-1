...
class lab_1_intro(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab_1_intro", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab_1_intro")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_1_intro")
        ...
        self.carrier_freq = carrier_freq = (center_freq - freq)
        ...
        if None:
            self._carrier_freq_formatter = None
        else:
            self._carrier_freq_formatter = lambda x: str(x)

        self._carrier_freq_tool_bar.addWidget(Qt.QLabel("Carrier Freq"))
        self._carrier_freq_label = Qt.QLabel(str(self._carrier_freq_formatter(self.carrier_freq)))
        self._carrier_freq_tool_bar.addWidget(self._carrier_freq_label)
        self.top_layout.addWidget(self._carrier_freq_tool_bar)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\jjtwd\\Documents\\GNURadio\\lab_1_intro\\am_broadcast_02_c900k_s400k.iq', True, 0, 0)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.set_carrier_freq((self.center_freq - self.freq))
    ...
    def set_carrier_freq(self, carrier_freq):
        ...
        Qt.QMetaObject.invokeMethod(self._carrier_freq_label, "setText", Qt.Q_ARG("QString", str(self._carrier_freq_formatter(self.carrier_freq))))
        self.analog_sig_source_x_0.set_frequency(self.carrier_freq)




def main(top_block_cls=lab_1_intro, options=None):
